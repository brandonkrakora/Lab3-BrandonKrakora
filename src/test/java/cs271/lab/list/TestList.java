...
public class TestList {
  ...
  public void setUp() throws Exception {
    ...
    // Completed also try with a LinkedList - does it make any difference?
  ...
  public void testSizeNonEmpty() {
    // Completed fix the expected values in the assertions below
    list.add(77);
  ...
  public void testContains() {
    // Completed write assertions using
  ...
  public void testContainsAll() {
    ...
    list.add(77);
    list.add(66);
    // Completed using containsAll and Arrays.asList (see above),
  ...
  public void testAddAll() {
    // Completed in a single statement using addAll and Arrays.asList
  ...
  public void testRemoveAll() {
    ...
    list.add(77);
    list.add(66);
    // Completed in a single statement using removeAll and Arrays.asList,
  ...
  public void testRetainAll() {
    ...
    list.add(77);
    list.add(66);
    // Completed in a single statement using retainAll and Arrays.asList,
  ...
  public void testSet() {
    ...
    list.add(77);
    list.add(66);
    // Completed use the set method to change specific elements in the list
    list.set(1, 99); list.set(3, 99); list.set(5, 99);
  ...
  public void testSubList() {
    ...
    list.add(77);
    list.add(66);
    // Completed fix the arguments in the subList method so that the assertion
    // passes
